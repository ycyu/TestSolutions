...
Sub Main()
	...
	Dim objFSO, objFile, objWFile, strLine, strDMCLI, strCMD_SCWS, strCMD_RI
	Dim fParamFile, fIniFile, fCsvFile, fTempFile, fLogFile
	Dim mProduct, mProject, mLocation, mChangeDocId, mFileName
	Dim strPath, strFileName, strMemo
	
	if WScript.Arguments.Count < 3 Then
		WScript.Echo "Usage: CScript //Nologo MCI.vbe <INI-File> <CSV-File>"
		WScript.Quit 1
	End if	
	...
	'SCWS "QLARIUS:QUOTE_WEB_1.0" /DEFAULT /DIR="C:\work\dmsys\QUOTE_WEB\" /NOCHECK
	strCMD_SCWS="SCWS ""##PROJECT##"" /DEFAULT /DIR=""##LOCATION##"" /NOCHECK"
	strCMD_SCWS=Replace(strCMD_SCWS, "##PROJECT##", mProject)
	strCMD_SCWS=Replace(strCMD_SCWS, "##LOCATION##", mLocation)
	objWFile.WriteLine(strCMD_SCWS)
	...
	Do While objFile.AtEndOfStream<>True
		...
		If regExp.Test(strLine) Then
			...
			'RI "SCRIPTS:;" /WORKSET="SCRIPTS:PRJ_SCRIPTS" /FILENAME="Test\Test.txt" /NOKEEP /CANCEL_UNCHANGED /ATTRIB=(Description="ATTR TEST_0820_2")
			strCMD_RI="RI ""##PRODUCT##"" /WORKSET=""##PROJECT##"" /FILENAME=""##FILENAME##"" /NOKEEP /CANCEL_UNCHANGED /ATTRIB=(Description=""##MEMO##"")"
			strCMD_RI=Replace(strCMD_RI, "##PRODUCT##", mProduct)
			strCMD_RI=Replace(strCMD_RI, "##PROJECT##", mProject)
			strCMD_RI=Replace(strCMD_RI, "##FILENAME##", Trim(strPath) & Trim(strFileName))
			strCMD_RI=Replace(strCMD_RI, "##MEMO##", strMemo)
			objWFile.WriteLine(strCMD_RI)
		End If
	Loop
