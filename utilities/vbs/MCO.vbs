...
Sub Main()
	...
	Dim objFSO, objFile, objWFile, strLine, strDMCLI, strCMD_SCWS, strCMD_EI
	...
	if WScript.Arguments.Count < 3 Then
		WScript.Echo "Usage: CScript //Nologo MCE.vbs <PARAM-File> <INI-File> <CSV-File>"
		WScript.Quit 1
	End if	
	...
	Do While objFile.AtEndOfStream<>True
		...
		If regExp.Test(strLine) Then
			...
			'EI "QLARIUS:;" /WORKSET="QLARIUS:QUOTE_WEB_1.0" /FILENAME="Qlarius_Home\images\auto-off.gif" /OVERWRITE /CHANGE_DOC_IDS="QLARIUS_DR_3"
			strCMD_EI="EI ""##PRODUCT##"" /WORKSET=""##PROJECT##"" /FILENAME=""##FILENAME##"" /OVERWRITE /CHANGE_DOC_IDS=""##CHANGE_DOC_ID##"""
			strCMD_EI=Replace(strCMD_EI, "##PRODUCT##", mProduct)
			strCMD_EI=Replace(strCMD_EI, "##PROJECT##", mProject)
			strCMD_EI=Replace(strCMD_EI, "##FILENAME##", Trim(strPath) & Trim(strFileName))
			strCMD_EI=Replace(strCMD_EI, "##CHANGE_DOC_ID##", mChangeDocID)
			objWFile.WriteLine(strCMD_EI)
		End If
	Loop
